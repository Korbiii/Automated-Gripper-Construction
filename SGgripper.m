...
CPL_screw_head_pattern = CPLcopyradial(PLcircle(servo.screw_R*1.375),servo.mount_screw_R,servo.mount_screw_Num);
...
CPL_bb_bottom = CPLconvexhull([PLcircle(axle_R+2);PLtrans(PLcircle(axle_R+2),[0 bb_bottom_length+2])]);
